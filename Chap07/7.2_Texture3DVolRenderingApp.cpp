/**********************************************************************
  ...
  文件名: 7.2_Texture3DVolRenderingApp.cpp
...
// #include <vtkVolumeTextureMapper3D.h>  // 已过时
...
int main(int argc, char *argv[])
{
	...
	// 已过时
	// /vtkVolumeTextureMapper3D 属于 vtkRenderingVolumeOpenGL 模块，该模块在 VTK 9.3.1 中 默认不编译

...
int main(int argc, char *argv[])
{
	...
	//cropping
	volumeMapper->SetCropping(1);  // 打开Cropping
	volumeMapper->SetCroppingRegionPlanes(100,200, 100,200, 100,200);  // 设置3个坐标轴上6个剪裁面的位置
	volumeMapper->SetCroppingRegionFlags(0x0002000);  // 设置显示哪个区域的标记
	...
	renWin->Render();
	renWin->SetWindowName("CroppingApp");
